...
class SEEMORE extends Main {
    constructor(NAME = 'seemore', ifFB = true, ifYT = false, ifScrollHandle = true) {
        ...
        if(typ=='city'){
            ...
            for(let i in cityies ){
                ...
                $('.select-county-blk').append(`
                  ...
                  <a class="info councilmen-area" href="/candidates/councilors/${cityies[i].cne}">
                  <p></p>
                  <p class="eng">01</p>
