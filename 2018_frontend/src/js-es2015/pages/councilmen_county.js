...
export {
    COUNCILMEN_COUNTY as COUNCILMEN_COUNTY,
};
...
class COUNCILMEN_COUNTY extends Main {
    ...
    anim() {
        ...
        $('.select-county-blk > div ').each(function(){
            ...
            let boxh=  $(this).find('.area-info').height();
            let contenth =   $(this).find('.area-info .areas').height();
            console.log("boxh..." + boxh)
            console.log("contenth..." + contenth)
            if(boxh < contenth){
                let t = 8//(boxh + contenth) / 25
