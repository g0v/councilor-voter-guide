...
for file_name in ['kcc/councilors_terms.json', 'tcc/councilors.json', 'tcc/councilors_terms.json', 'tcc/meeting_minutes-2010.json', 'tcc/bills-2010.json', 'tncc/tnccp/tnccp.json']:
    print file_name
