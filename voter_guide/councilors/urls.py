...
urlpatterns = patterns('',
    ...
    url(r'^(?P<index>conscience_vote|not_voting|bills|cs_attend|countys)/(?P<county>\S+)/(?P<ad>\d+)/$', views.index, name='index'),
    ...
    url(r'^voter/(?P<councilor_id>\S+)/(?P<ad>\d+)/$', views.voter, name='voter'),
