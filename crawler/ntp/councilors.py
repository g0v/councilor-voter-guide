...
class Spider(scrapy.Spider):
    ...
    def parse_profile(self, response):
        ...
        c['education'] = [x.strip() for x in response.xpath(u'//img[@alt="學歷"]/ancestor::tr[1]/following-sibling::tr[1]/descendant::td/text()').extract()]
        c['experience'] = [x.strip() for x in response.xpath(u'//img[@alt="經歷"]/ancestor::tr[1]/following-sibling::tr[1]/descendant::td/text()').extract()]
        c['title'] = response.xpath(u'//img[@alt="現任"]/ancestor::tr[1]/following-sibling::tr[1]/descendant::td/text()').re(u'第\d+屆(.+)')[0]
        c['platform'] = [x.strip() for x in response.xpath(u'//img[@alt="政見"]/ancestor::tr[1]/following-sibling::tr[1]/descendant::td/text()').extract()]
