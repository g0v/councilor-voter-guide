...
class Spider(scrapy.Spider):
    ...
    def parse_file(self, response):
        for node in response.css(u'a.abc4'):
            item = {}
            ...
            cmd = u'mkdir -p ../../data/ntp/suggestions/ && wget --heade="User-Agent:Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36" -q -O ../../data/ntp/suggestions/{year}_{month_from}-{month_to}.{file_ext} "{url}"'.format(**item)
