...
class Spider(scrapy.Spider):
    ...
    def parse_profile(self, response):
        ...
        item['constituency'] = region[0] if len(region) > 1 else ''
        ...
        item['education'] = [x.strip() for x in response.xpath('//*[@id="ctl00_ContentPlaceHolder1_Members1_LB_MEM_WORK"]/text()').extract() if x.strip()]
